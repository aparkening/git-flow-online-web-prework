...
# describe "PUSHING:" do
  ...
  it "6. From the feature branch 'add-links', what is the syntax for creating a remote add-links branch with all of the local branch's content? (remote is still called 'origin')" do
  ...
  it "8. From the feature branch 'add-image', what is the syntax for creating a remote add-image branch with all of the local branch's content? (remote is still called 'upstream')" do
...
# describe "FETCHING:" do
  ...
  it "10. Locally you have a master branch, remotely there is a master & add-nav-bar branch. You run 'git fetch --all'. What command would you need to run to view and change 'add-nav-bar' branch locally?" do
...
# describe "MERGING:" do
  ...
  it "26. Once you've resolved merge conflicts, you must stage and commit the files in which there were conflicts" do
    # "true" or "false", in a string
    answer = "true"
